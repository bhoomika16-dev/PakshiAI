...
def train_model():
    ...
    with open('backend/core/vision_classes.json', 'w') as f:
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_acc:
            best_acc = val_acc
            torch.save(model.state_dict(), 'backend/core/vision_model.pth')
            print(f"--> Improved Accuracy. Checkpoint saved.")

    print(f"Training Complete. Best Validation Accuracy: {best_acc:.4f}")
    print("Final Neural weights synchronized to backend/core/vision_model.pth")
